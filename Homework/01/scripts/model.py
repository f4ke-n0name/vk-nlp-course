...
class Model(nn.Module):
    ...
    def __init__(
        ...
        self.lstm = nn.LSTM(self.emb_size, self.hidden_size, self.num_layers, dropout=self.dropout, batch_first=True)
